    ...
    <div>
      ...
      {preview ? (
        ...
        >
          ...
          <span className="absolute right-2 top-2 flex items-center gap-1 rounded-full bg-green-600 px-2 py-1 text-xs font-semibold text-white">
        ...
        >
          <Camera className="h-5 w-5" /> {compressing ? "Processing..." : `Take ${label.toLowerCase()}`}
        </button>
      )}
    </div>
  );
